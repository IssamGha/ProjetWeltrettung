...
namespace ProjetWeltrettung.Controllers
{
    public class HeldsController : Controller
    {
        ...
        public HeldsController(ProjetWeltrettungContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Helden.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var held = await _context.Helden
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var held = await _context.Helden.FindAsync(id);
            if (held == null)
            {
                return NotFound();
            }
        ...
        {
            return _context.Helden.Any(e => e.HeldId == id);
        }
    }
}
